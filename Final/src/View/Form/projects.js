        ...
        <Grid container spacing={3}>
          ...
          <Grid item md={4} xs={12}>
            <TextField
              fullWidth
              name={`github`}
              defaultValue={props.projectFormData.Data && props.projectFormData.Data[i] ? props.projectFormData.Data[i].github : ""}
      ...
      <form autoComplete="off" noValidate>
        <Card>
          ...
          <div className={classes.footer}>
           <Button disabled={ props.projectFormData.Count<2} className={classes.deleteButton} onClick={Deleteducation} variant="contained" color="primary" >
            Delete
          </Button>
